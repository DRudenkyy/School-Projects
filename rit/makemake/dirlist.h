/* dirlist.h
 *
 * $Id: dirlist.h,v 1.2 2011/05/26 03:45:14 sidney Exp $
 *
 * $Log: dirlist.h,v $
 * Revision 1.2  2011/05/26 03:45:14  sidney
...
public: // Constructors
  ...
  enum FileType { C, CPP, H, ARCHIVE, PREASSEMBLY, ASSEMBLY, OTHER }; // file type
  ...
  set<string> preass_main;  // All preassembly files with main
  set<string> preass_other; // Non-main preassembly files
